"""
Django settings for roomReserveBackend project.
...
SECRET_KEY = 'django-insecure-nsvkp78v02=!1a8pu(wk+x^om3o@ti!q*)r+5x8-gbh$34f&px'
...
ROOT_URLCONF = 'roomReserveBackend.urls'
...
WSGI_APPLICATION = 'roomReserveBackend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'roomReserve-db',
        'USER': 'postgres',
        'PASSWORD': '3214', # Consider using environment variables for security
...
REST_FRAMEWORK = {
    ...
    # Add default permission classes if desired later
    # 'DEFAULT_PERMISSION_CLASSES': [
    #     'rest_framework.permissions.IsAuthenticatedOrReadOnly',
    # ],
    'DEFAULT_FILTER_BACKENDS': ['django_filters.rest_framework.DjangoFilterBackend'], # Add default filter backend
}
...
# Optional: Specify allowed methods, headers, etc. if defaults aren't sufficient
# CORS_ALLOW_METHODS = [
#     "DELETE",
#     "GET",
#     "OPTIONS",
